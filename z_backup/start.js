...
//   let isiPesan = res.text
//   // let type = res.entities[0].type //message, text, entities, bot_command

//   Logger.log("typeeeeeeeeeeeeeeeeeeeeee");
//   Logger.log(res);
//   // Logger.log(type);

//   // ctx.telegram.sendMessage(chatid, isiPesan)
//   ctx.replyIt(isiPesan)
//   // ctx.replyIt(res)
// })
...
//   let res = ctx?.message
//   let isiPesan = res.text
//   let accFromGrup = res?.reply_to_message?.forum_topic_created?.name
//   let chatid = res.chat.id

//   // Logger.log(type);

//   let datas = parseMessage(isiPesan)
//   let account = datas?.account
//   Logger.log(account)
...
//       account = accFromGrup
//     } else {
//     Logger.log("account kosong")

//       return ctx.replyIt("mohon masukkan account trading dengan format #<nama akun>")
//     }
